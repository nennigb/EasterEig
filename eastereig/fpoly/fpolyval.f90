...
! Evaluation of a uni-vartiate polynomial with convention a_i x**i, i=0, nx
...
! Evaluation of bi-vartiate polynomial with convention a_ij x**i * y**j
...
! Evaluation of a tri-vartiate polynomial with convention a_ijk x**i * y**j * z**k
